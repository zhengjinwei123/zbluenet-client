...
inline void MessageCustomOption::SharedCtor() {
}
...
inline void MessageCustomOption::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}
...
void MessageCustomOption::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<MessageCustomOption *>(to)->MergeFrom(
      static_cast<const MessageCustomOption &>(from));
}
...
inline void MessageCustomOption2::SharedCtor() {
}
...
inline void MessageCustomOption2::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}
...
void MessageCustomOption2::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<MessageCustomOption2 *>(to)->MergeFrom(
      static_cast<const MessageCustomOption2 &>(from));
}
