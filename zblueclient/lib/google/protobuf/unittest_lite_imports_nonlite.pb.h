...
class TestLiteImportsNonlite final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::protobuf_unittest::TestAllTypes* release_message();
  ...
  PROTOBUF_MUST_USE_RESULT ::protobuf_unittest::TestRequired* release_message_with_required();
