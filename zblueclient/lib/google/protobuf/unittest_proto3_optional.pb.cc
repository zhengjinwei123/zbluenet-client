...
inline void Proto3OptionalExtensions::SharedCtor() {
}
...
inline void Proto3OptionalExtensions::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}
...
void Proto3OptionalExtensions::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<Proto3OptionalExtensions *>(to)->MergeFrom(
      static_cast<const Proto3OptionalExtensions &>(from));
}
