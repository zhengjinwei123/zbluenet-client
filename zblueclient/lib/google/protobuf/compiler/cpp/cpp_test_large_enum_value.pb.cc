...
inline void TestLargeEnumValue::SharedCtor() {
}
...
inline void TestLargeEnumValue::SharedDtor() {
...
void TestLargeEnumValue::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<TestLargeEnumValue *>(to)->MergeFrom(
      static_cast<const TestLargeEnumValue &>(from));
}
