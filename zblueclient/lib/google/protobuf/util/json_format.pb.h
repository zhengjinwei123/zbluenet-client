...
class TestBase64ByteArrays final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_a();
...
class TestJavaScriptJSON final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_var();
...
class TestCamelCase final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_normal_field();
...
class TestRecursion final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::protobuf_unittest::TestRecursion* release_child();
...
class TestStringSerializer final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_scalar_string();
