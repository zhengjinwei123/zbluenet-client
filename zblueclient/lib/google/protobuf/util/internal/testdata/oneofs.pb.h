...
class OneOfsRequest final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT PROTOBUF_NAMESPACE_ID::Any* release_any_data();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_str_data();
  ...
  PROTOBUF_MUST_USE_RESULT ::proto_util_converter::testing::oneofs::Data* release_message_data();
  ...
  PROTOBUF_MUST_USE_RESULT ::proto_util_converter::testing::oneofs::MoreData* release_more_data();
  ...
  PROTOBUF_MUST_USE_RESULT PROTOBUF_NAMESPACE_ID::Value* release_value_data();
  ...
  PROTOBUF_MUST_USE_RESULT PROTOBUF_NAMESPACE_ID::ListValue* release_list_value_data();
  ...
  PROTOBUF_MUST_USE_RESULT PROTOBUF_NAMESPACE_ID::Timestamp* release_ts_data();
